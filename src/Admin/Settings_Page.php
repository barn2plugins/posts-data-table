...
use Barn2\PTS_Lib\Util,
    ...
    Barn2\PTS_Lib\Admin\Plugin_Promo,
...
class Settings_Page implements Registerable {
    ...
    public function register_settings() {
        ...
        register_setting( self::OPTION_GROUP, Settings::TABLE_ARGS_SETTING, [
        ...
        Settings_API_Helper::add_settings_section(
            'ptss_post_selection', self::MENU_SLUG, __( 'Posts selection', 'posts-data-table' ), [ $this, 'section_description_selecting_posts' ],
        ...
        // Table content
        Settings_API_Helper::add_settings_section(
            'ptss_content', self::MENU_SLUG, __( 'Table content', 'posts-data-table' ), [ $this, 'section_description_table_content' ],
            $this->mark_readonly_settings( [
                [
