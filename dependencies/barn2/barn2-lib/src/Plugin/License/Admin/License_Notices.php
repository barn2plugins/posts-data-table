...
namespace Barn2\Plugin\Posts_Table_Search_Sort\Dependencies\Lib\Plugin\License\Admin;
...
class License_Notices implements Registerable
{
    ...
    public function first_activation_notice()
    {
        ...
        \printf(
            ...
            __('Thank you for installing %1$s. To get started, please %2$senter your license key%3$s.', 'barn2'),
            $plugin_name,
